...
class AudioDetailListHome extends StatelessWidget {
  const AudioDetailListHome({super.key});
      ...
      builder: (context) {
        return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return audioWidget(controller, index, isPlaying, audioItem);
            });
      }
    );
  }

  Widget audioWidget(HomeController controller, int index, bool isPlaying, AudioItem audioItem) {
